...
sudo pacman --noconfirm -S kitty flameshot thunar nwg-look nwg-bar brightnessctl pavucontrol playerctl rofi dunst ttf-jetbrains-mono-nerd tuned-ppd system-config-printer print-manager kwallet nm-applet
